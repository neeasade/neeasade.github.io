...
(def all-diaries
  {:Karamja-Diary
   {:easy
    {:requirements
     {:skills
      [{:skill "Mining", :level 40} {:skill "Agility", :level 15}],
      :quests [],
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Agility", :level 10}], :quests [], :other []}}
      {:task
       "Mine some gold from the rocks on the north-west peninsula of Karamja .",
       :requirements
       {:skills [{:skill "Mining", :level 40}],
        :quests [],
        :other ["Any pickaxe"]}}
      ...
      {:task "Explore Cairn Island to the west of Karamja .",
       :requirements
       {:skills [{:skill "Agility", :level 15}], :quests [], :other []}}
      {:task
    ...
    {:requirements
     ...
     [{:task "Claim a ticket from the Agility Arena in Brimhaven .",
      ...
      {:task "Earn 100% favour in the village of Tai Bwo Wannai .",
       :requirements
       {:skills [{:skill "Woodcutting", :level 10}],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task "Eat an oomlie wrap .",
       :requirements
       {:skills [{:skill "Cooking", :level 50}], :quests [], :other []}}
      {:task "Craft some nature runes from Essence.",
       :requirements
       {:skills [{:skill "Runecraft", :level 44}],
        :quests [],
        :other
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Agility", :level 79}],
        :quests ["Legends' Quest"],
        :other []}}
      {:task
       "Be assigned a Slayer task by the Slayer Master in Shilo Village .",
       :requirements
       {:skills [{:skill "Combat level", :level 100}],
        :quests ["Shilo Village"],
        :other []}}
    ...
    {:requirements
     {:skills
      [{:skill "Mining", :level 52}
       ...
       {:skill "Fletching", :level 1}
       {:skill "Woodcutting", :level 50}
       {:skill "Runecraft", :level 91}
       {:skill "Slayer", :level 50}
       {:skill "Farming", :level 72}
       {:skill "Hunter", :level 41}],
      :quests ["The Grand Tree" "Tai Bwo Wannai Trio"],
      :other
      ["Quest points: 107"
     ...
     [{:task
       ...
       :requirements
       {:skills [{:skill "Runecraft", :level 91}],
        :quests [],
        :other
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Herblore", :level 87}],
        :quests [],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Crafting", :level 23}],
        :quests ["The Fremennik Trials"],
        :other
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Woodcutting", :level 15}],
        :quests [],
        :other
    ...
    {:requirements
     ...
     [{:task "Slay a Brine rat .",
      ...
      {:task "Catch a Snowy knight .",
       :requirements
       {:skills
        [{:skill "Hunter", :level 45} {:skill "Hunter", :level 35}],
        :quests [],
        :other []}}
      {:task
       ...
       :requirements
       {:skills [{:skill "Construction", :level 37}],
        :quests ["The Fremennik Trials"],
        :other
      ...
      {:task
       ...
       :requirements
       {:skills
        [{:skill "Prayer", :level 43} {:skill "Agility", :level 85}],
      ...
      {:task
       ...
       :requirements
       {:skills
        [{:skill "Mining", :level 40} {:skill "Defence", :level 30}],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task "Steal a cake from the Ardougne market stalls .",
       :requirements
       {:skills [{:skill "Thieving", :level 5}], :quests [], :other []}}
      {:task
    ...
    {:requirements
     ...
     [{:task "Enter the Unicorn pen in Ardougne zoo using Fairy rings .",
      ...
      {:task "Grapple over Yanille 's south wall.",
       :requirements
       {:skills [{:skill "Agility", :level 39}],
        :quests [],
        :other ["Mith grapple [ a ] and any crossbow"]}}
      {:task
       "Harvest some strawberries from the Ardougne farming patch .",
       :requirements
       {:skills [{:skill "Farming", :level 31}],
        :quests [],
        :other
      ...
      {:task "Pickpocket the master farmer north of Ardougne .",
       :requirements
       {:skills [{:skill "Thieving", :level 38}], :quests [], :other []}}
      {:task
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task "Enter the Magic Guild .",
       :requirements
       {:skills [{:skill "Magic", :level 66}], :quests [], :other []}}
      {:task "Steal from a chest in Ardougne Castle .",
       :requirements
       {:skills [{:skill "Thieving", :level 72}],
        :quests [],
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Runecraft", :level 65}],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Thieving", :level 82}],
        :quests [],
        :other ["Lockpick"]}}
      {:task "Pickpocket a Hero .",
       :requirements
       {:skills [{:skill "Thieving", :level 80}], :quests [], :other []}}
      {:task
       ...
       :requirements
       {:skills [{:skill "Crafting", :level 10}],
        :quests [],
        :other
      ...
      {:task "Complete a lap of Ardougne's rooftop agility course .",
       :requirements
       {:skills [{:skill "Agility", :level 90}], :quests [], :other []}}
      {:task
   ...
   {:easy
    {:requirements
     ...
     [{:task "Mine some Iron at the Mount Karuulm mine .",
      ...
      {:task "Steal from a Hosidius Food Stall .",
       :requirements
       {:skills [{:skill "Thieving", :level 25}], :quests [], :other []}}
      ...
      {:task "Enter your Player Owned House from Hosidius .",
       :requirements
       {:skills [{:skill "Construction", :level 25}],
        :quests [],
        :other
      ...
      {:task "Create a Strength potion in the Lovakengj Pub .",
       :requirements
       {:skills [{:skill "Herblore", :level 12}],
        :quests ["Druidic Ritual"],
    ...
    {:requirements
     ...
     [{:task "Travel to the Fairy Ring south of Mount Karuulm .",
      ...
      {:task "Catch a Chinchompa in the Kourend Woodland .",
       :requirements
       {:skills [{:skill "Hunter", :level 53}],
        :quests ["Eagles' Peak"],
        :other ["Box trap"]}}
      {:task "Chop some Mahogany logs north of the Farming Guild .",
       :requirements
       {:skills [{:skill "Woodcutting", :level 50}],
        :quests [],
        :other ["Any axe"]}}]},
    :hard
    {:requirements
     ...
     [{:task "Enter the Woodcutting Guild .",
      ...
      {:task "Mine some Lovakite .",
       :requirements
       {:skills [{:skill "Mining", :level 65}],
        :quests [],
        :other ["Any pickaxe"]}}
      {:task "Plant some Logavano seeds at the Tithe Farm .",
       :requirements
       {:skills [{:skill "Farming", :level 74}],
        :quests [],
        :other ["Seed dibber"]}}
      ...
      {:task "Deliver an artefact to Captain Khaled .",
       :requirements
       {:skills [{:skill "Thieving", :level 49}],
        :quests [],
        :other ["Lockpick"]}}
      {:task "Kill a Wyrm in the Karuulm Slayer Dungeon .",
       :requirements
       {:skills [{:skill "Slayer", :level 62}],
        :quests [],
        :other
    ...
    {:requirements
     ...
     [{:task
       ...
       :requirements
       {:skills [{:skill "Runecraft", :level 77}],
        :quests [],
        :other ["Any pickaxe and chisel"]}}
      {:task "Chop some Redwood logs .",
       :requirements
       {:skills [{:skill "Woodcutting", :level 90}],
        :quests [],
        :other ["Any axe"]}}
   ...
   {:easy
    {:requirements
     ...
     [{:task "Browse Thessalia's store .",
      ...
      {:task "Jump over the fence south of Varrock .",
       :requirements
       {:skills [{:skill "Agility", :level 13}], :quests [], :other []}}
      ...
      {:task "Craft some Earth runes from Essence.",
       :requirements
       {:skills [{:skill "Runecraft", :level 9}],
        :quests [],
        :other
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills
        [{:skill "Farming", :level 30} {:skill "Firemaking", :level 40}],
        :quests ["Enlightened Journey"],
        :other
    ...
    {:requirements
     ...
     [{:task
       ...
       :requirements
       {:skills
        [{:skill "Hunter", :level 66} {:skill "Hunter", :level 69}],
        :quests [],
        :other ["800 coins"]}}
      ...
      {:task "Make a Waka canoe near Edgeville .",
       :requirements
       {:skills [{:skill "Woodcutting", :level 57}],
        :quests [],
        :other ["Any axe"]}}
      {:task "Teleport to Paddewwa .",
       :requirements
       {:skills [{:skill "Magic", :level 54}],
        :quests ["Desert Treasure I"],
        :other
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Prayer", :level 52}], :quests [], :other []}}
      {:task "Squeeze through the obstacle pipe in Edgeville dungeon .",
       :requirements
       {:skills [{:skill "Agility", :level 51}],
        :quests [],
        :other []}}]},
    :elite
    {:requirements
     {:skills
      [{:skill "Mining", :level 60}
       ...
       {:skill "Crafting", :level 61}
       {:skill "Firemaking", :level 60}
       {:skill "Magic", :level 86}
       {:skill "Fletching", :level 81}
       {:skill "Woodcutting", :level 60}
       {:skill "Runecraft", :level 78}
       {:skill "Farming", :level 68}
       {:skill "Construction", :level 50}
       {:skill "Hunter", :level 66}],
      :quests
     ...
     [{:task "Create a super combat potion in Varrock west bank .",
       :requirements
       {:skills [{:skill "Herblore", :level 90}],
        :quests ["Druidic Ritual"],
        :other
      ...
      {:task "Smith and fletch ten rune darts within Varrock .",
       :requirements
       {:skills [{:skill "Smithing", :level 89}],
    ...
    {:requirements
     ...
     [{:task "Complete a lap of the Barbarian agility course .",
      ...
      {:task
       ...
       :requirements
       {:skills
        [{:skill "Agility", :level 36} {:skill "Agility", :level 70}],
        :quests [],
        :other
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Thieving", :level 47}],
        :quests [],
        :other
        ["Lockpick"
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task "Complete a lap of the Seers' Village agility course .",
       :requirements
       {:skills [{:skill "Agility", :level 60}], :quests [], :other []}}
      {:task
      ...
      {:task "Burn some Maple logs with a bow in Seers' Village .",
       :requirements
       {:skills [{:skill "Firemaking", :level 65}],
        :quests [],
        :other
      ...
      {:task "Kill a Shadow Hound in the Shadow dungeon .",
       :requirements
       {:skills [{:skill "Thieving", :level 53}],
        :quests ["Desert Treasure I"],
        :other
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Strength", :level 50}],
        :quests [],
        :other
      ...
      {:task "Smith an Adamant spear at Otto's Grotto .",
       :requirements
       {:skills [{:skill "Smithing", :level 75}],
        :quests [],
        :other
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Herblore", :level 86}],
        :quests [],
        :other
      ...
      {:task "Smith a Rune Hasta at Otto's Grotto .",
       :requirements
       {:skills [{:skill "Smithing", :level 90}],
        :quests [],
        :other
        ["Access to Barbarian Smithing"
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Firemaking", :level 85}],
        :quests [],
        :other
        ["Access to Barbarian Firemaking"
   ...
   {:easy
    {:requirements
     {:skills
      [{:skill "Mining", :level 15}
       ...
       {:skill "Firemaking", :level 15}
       {:skill "Woodcutting", :level 15}
       {:skill "Runecraft", :level 5}
       {:skill "Slayer", :level 7}],
     ...
     [{:task "Complete a lap of the Draynor Village agility course .",
      ...
      {:task "Craft some water runes from Essence.",
       :requirements
       {:skills [{:skill "Runecraft", :level 5}],
        :quests [],
        :other
        ["Pure , daeyalt , or rune essence"
    ...
    {:requirements
     {:skills
      [{:skill "Mining", :level 15}
       ...
       {:skill "Fletching", :level 1}
       {:skill "Woodcutting", :level 36}
       {:skill "Runecraft", :level 23}
       {:skill "Slayer", :level 18}
       {:skill "Hunter", :level 42}],
     ...
     [{:task "Complete a lap of the Al Kharid agility course .",
       :requirements
       {:skills [{:skill "Agility", :level 20}], :quests [], :other []}}
      {:task "Grapple across the River Lum .",
       :requirements
       {:skills [{:skill "Agility", :level 8}],
        :quests [],
        :other ["Mith grapple [ a ] and any crossbow"]}}
      {:task "Purchase an upgraded device from Ava .",
       :requirements
       {:skills [{:skill "Ranged", :level 50}],
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Runecraft", :level 23}],
        :quests [],
        :other
    ...
    {:requirements
     {:skills
      [{:skill "Mining", :level 50}
       ...
       {:skill "Fletching", :level 10}
       {:skill "Woodcutting", :level 57}
       {:skill "Runecraft", :level 59}
       {:skill "Slayer", :level 18}
       {:skill "Farming", :level 63}
       {:skill "Hunter", :level 42}],
      :quests
      ["Animal Magnetism"
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Runecraft", :level 59}],
        :quests ["Lost City"],
        :other
        ["28 pure or daeyalt essence (less may suffice with Raiments of the Eye pieces) [ a ]"
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Crafting", :level 70}],
        :quests [],
        :other
    ...
    {:requirements
     ...
     [{:task "Steal from a Dorgesh-Kaan rich chest .",
       :requirements
       {:skills [{:skill "Thieving", :level 78}],
      ...
      {:task "Chop some magic logs at the Mage Training Arena .",
       :requirements
       {:skills [{:skill "Woodcutting", :level 75}],
        :quests [],
        :other ["Any axe"]}}
      {:task "Smith an Adamant platebody down Draynor sewer . [ sic ]",
       :requirements
       {:skills [{:skill "Smithing", :level 88}],
        :quests [],
    ...
    {:requirements
     ...
     [{:task "Catch a Copper Longtail .",
      ...
      {:task "Fletch an Oak Shortbow in the Gnome Stronghold .",
       :requirements
       {:skills [{:skill "Fletching", :level 20}],
        :quests [],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Woodcutting", :level 35}],
        :quests ["Monkey Madness I"],
        :other ["Any axe and tinderbox"]}}
      {:task
    ...
    {:requirements
     {:skills
      [{:skill "Mining", :level 70}
       ...
       {:skill "Woodcutting", :level 50}
       {:skill "Farming", :level 68}
       {:skill "Construction", :level 65}
       {:skill "Hunter", :level 69}],
      :quests
      ["Eagles' Peak"
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Hunter", :level 69}],
        :quests [],
        :other ["500 coins"]}}
      {:task "Complete a lap of the Ape Atoll agility course .",
       :requirements
       {:skills [{:skill "Agility", :level 48}],
        :quests ["Monkey Madness I"],
        :other
      ...
      {:task "Build an Isafdar painting in your POH Quest hall .",
       :requirements
       {:skills [{:skill "Construction", :level 65}],
        :quests ["Roving Elves"],
        :other
    ...
    {:requirements
     {:skills
      [{:skill "Attack", :level 42}
       ...
       {:skill "Fishing", :level 62}
       {:skill "Ranged", :level 70}
       {:skill "Thieving", :level 85}
       {:skill "Cooking", :level 70}
       {:skill "Prayer", :level 22}
       {:skill "Crafting", :level 40}
       {:skill "Firemaking", :level 50}
       {:skill "Magic", :level 66}
       {:skill "Fletching", :level 85}
       {:skill "Woodcutting", :level 50}
     ...
     [{:task "Fletch a Magic Longbow in Tirannwn .",
       :requirements
       {:skills [{:skill "Fletching", :level 85}],
        :quests ["Regicide"],
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Slayer", :level 93}],
        :quests [],
        :other ["See the strategy guide"]}}
      {:task "Have Prissy Scilla protect your Magic tree .",
       :requirements
       {:skills [{:skill "Farming", :level 75}],
        :quests [],
      ...
      {:task "Pickpocket an Elf .",
       :requirements
       {:skills [{:skill "Thieving", :level 85}],
        :quests ["Mourning's End Part I"],
        :other []}}]}},
   :Falador-Diary
   {:easy
    {:requirements
     ...
     [{:task
       ...
       :requirements
       {:skills [{:skill "Construction", :level 16}],
        :quests [],
        :other []}}
      {:task "Climb over the western Falador wall.",
       :requirements
       {:skills [{:skill "Agility", :level 5}], :quests [], :other []}}
    ...
    {:requirements
     {:skills
      [{:skill "Mining", :level 40}
       ...
       {:skill "Crafting", :level 40}
       {:skill "Firemaking", :level 49}
       {:skill "Magic", :level 37}
       {:skill "Fletching", :level 1}
       {:skill "Woodcutting", :level 30}
       {:skill "Slayer", :level 32}
       {:skill "Farming", :level 23}
       {:skill "Construction", :level 16}],
      :quests
      ["Doric's Quest"
       "The Knight's Sword"
     ...
     [{:task "Light a Bullseye lantern at the Chemist's in Rimmington .",
       :requirements
       {:skills [{:skill "Firemaking", :level 49}],
        :quests [],
      ...
      {:task "Craft a fruit basket on the Falador Farm loom .",
       :requirements
       {:skills [{:skill "Crafting", :level 36}],
        :quests [],
        :other ["6 Willow branches"]}}
      {:task "Teleport to Falador .",
       :requirements
       {:skills [{:skill "Magic", :level 37}],
        :quests [],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Thieving", :level 50}], :quests [], :other []}}
      {:task
       "Recharge your prayer in the Port Sarim church while wearing full Proselyte .",
       :requirements
       {:skills
        [{:skill "Defence", :level 30} {:skill "Prayer", :level 20}],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task "Mix a Saradomin brew in Falador east bank .",
       :requirements
       {:skills [{:skill "Herblore", :level 81}],
        :quests [],
   ...
   {:easy
    ...
    {:requirements
     ...
     [{:task "Mine some Mithril ore in the wilderness .",
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Woodcutting", :level 61}],
        :quests [],
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Smithing", :level 50}],
        :quests ["Between a Rock..."],
    ...
    {:requirements
     {:skills
      [{:skill "Mining", :level 55}
       {:skill "Agility", :level 64}
       {:skill "Smithing", :level 75}
       {:skill "Fishing", :level 53}
       {:skill "Magic", :level 66}
       {:skill "Woodcutting", :level 61}
       {:skill "Slayer", :level 68}
    ...
    {:requirements
     {:skills
      [{:skill "Mining", :level 85}
       ...
       {:skill "Ranged", :level 40}
       {:skill "Thieving", :level 84}
       {:skill "Cooking", :level 90}
       {:skill "Firemaking", :level 75}
       {:skill "Magic", :level 96}
       {:skill "Fletching", :level 10}
       {:skill "Woodcutting", :level 75}
       {:skill "Slayer", :level 83}
       {:skill "Hunter", :level 67}],
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Thieving", :level 84}], :quests [], :other []}}
      {:task
   ...
   {:easy
    {:requirements
     {:skills
      [{:skill "Cooking", :level 12}
       {:skill "Crafting", :level 15}
       {:skill "Slayer", :level 15}
       {:skill "Farming", :level 23}],
     ...
     [{:task
      ...
      {:task "Get a slayer task from the Slayer Master in Canifis .",
       :requirements
       {:skills [{:skill "Combat level", :level 20}],
        :quests [],
        :other []}}
      {:task "Kill a Banshee in the Slayer Tower .",
       :requirements
       {:skills [{:skill "Slayer", :level 15}],
        :quests [],
    ...
    {:requirements
     ...
     [{:task "Catch a swamp lizard .",
       :requirements
       {:skills [{:skill "Hunter", :level 29}],
        :quests [],
        :other ["Rope and small fishing net"]}}
      {:task "Complete a lap of the Canifis agility course .",
       :requirements
       {:skills [{:skill "Agility", :level 40}], :quests [], :other []}}
      {:task "Obtain some Bark from a Hollow tree .",
       :requirements
       {:skills [{:skill "Woodcutting", :level 45}],
        :quests [],
        :other ["Any axe"]}}
      {:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Smithing", :level 35}],
        :quests ["Dwarf Cannon"],
        :other
      ...
      {:task "Mix a Guthix Balance potion while in Morytania .",
       :requirements
       {:skills [{:skill "Herblore", :level 22}],
    ...
    {:requirements
     ...
     [{:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Agility", :level 65}], :quests [], :other []}}
    ...
    {:requirements
     {:skills
      [{:skill "Attack", :level 20}
       ...
       {:skill "Cooking", :level 40}
       {:skill "Prayer", :level 70}
       {:skill "Crafting", :level 84}
       {:skill "Firemaking", :level 80}
       {:skill "Magic", :level 83}
       {:skill "Fletching", :level 10}
     ...
     [{:task "Catch a shark in Burgh de Rott with your bare hands.",
      ...
      {:task "Craft a Black dragonhide body in Canifis bank .",
       :requirements
       {:skills [{:skill "Crafting", :level 84}],
        :quests [],
        :other
    ...
    {:requirements
     ...
     [{:task "Catch a Golden Warbler .",
      ...
      {:task "Open the Sarcophagus in the first room of Pyramid Plunder",
       :requirements
       {:skills [{:skill "Thieving", :level 21}],
    ...
    {:requirements
     ...
     [{:task "Climb to the summit of the Agility Pyramid .",
      ...
      {:task "Slay a desert lizard .",
       :requirements
       {:skills [{:skill "Slayer", :level 22}],
        :quests [],
        :other ["Ice cooler"]}}
      {:task "Catch an Orange Salamander .",
       :requirements
       {:skills [{:skill "Hunter", :level 47}],
        :quests [],
      ...
      {:task "Create a combat potion in the desert .",
       :requirements
       {:skills [{:skill "Herblore", :level 36}],
        :quests [],
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Construction", :level 20}],
        :quests [],
    ...
    {:requirements
     ...
     [{:task "Knock out and pickpocket a Menaphite Thug .",
      ...
      {:task "Complete a lap of the Pollnivneach agility course .",
       :requirements
       {:skills [{:skill "Agility", :level 70}], :quests [], :other []}}
      {:task
       "Slay a Dust Devil in the desert cave with a Slayer helmet equipped.",
       :requirements
       {:skills
        [{:skill "Slayer", :level 65} {:skill "Crafting", :level 55}],
        :quests ["Desert Treasure I"],
        :other []}}
      {:task
      ...
      {:task
       ...
       :requirements
       {:skills [{:skill "Firemaking", :level 60}],
        :quests [],
    ...
    {:requirements
     ...
     [{:task "Bake a wild pie at the Nardah Clay Oven .",
      ...
      {:task "Fletch some Dragon darts at the Bedabin Camp .",
       :requirements
       {:skills [{:skill "Fletching", :level 95}],
        :quests [],
        :other ["Dragon dart tip and feather"]}}
      {:task
       "Speak to the KQ head in your POH . Note: The Kalphite Queen has a 1/128 chance on dropping her head on death. She's also guaranteed to drop a tattered head on the 256th kill, which functions the same.",
       :requirements
       {:skills [{:skill "Construction", :level 78}],
