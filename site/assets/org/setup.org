...
#+HTML_HEAD: <link rel="stylesheet" href="/assets/css/org.css">
#+HTML_HEAD: <link rel="stylesheet" href="./assets/css/org.css">

#+HTML_HEAD: <link rel="stylesheet" href="/assets/css/colors.css">
#+HTML_HEAD: <link rel="stylesheet" href="./assets/css/colors.css">

#+HTML_HEAD: <link rel="stylesheet" href="/assets/css/notes.css">
#+HTML_HEAD: <link rel="stylesheet" href="./assets/css/notes.css">

#+HTML_HEAD: <link rel="stylesheet" href="/assets/css/new.css">
#+HTML_HEAD: <link rel="stylesheet" href="./assets/css/new.css">
...
#+MACRO:  color (eval (ns/blog-make-color-preview $1))
