...
It has the luxury of assuming the location of the dotfiles repo, and tries to match the stow link
path style of stow. Like many scripts used onlyl for the personal deployment of inconsequential
...
This time I had things in place for a few days before my muscle memory let me to try and 'stow'
